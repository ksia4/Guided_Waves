...
\@ifclassloaded{aghdpl}{
  ...
  \titlePL{Metody kompensacji dyspersji dla fal prowadzonych propagujących w prętach stalowych}
  \titleEN{Dispersion compensation methods of guided waves(GW) propagating in steel bars}
