...
\input{3_1_rozwiazywanie_zadan_z_pomoca_mes}


\input{3_2_funkcje_ksztaltu}

\input{3_3_wyznaczanie_macierzy_sztywnosci_i_mas_elementu}

\input{3_4_agregacja_globlanych_macierzy_mas_i_sztywnosci}

\input{3_5_rozwiazanie_wyznaczonego_rownania_macierzowego}

\input{3_6_stablinosc_metody_i_bledy_rozwiazania}
