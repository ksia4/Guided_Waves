...
\subsection{Przykład zastoosowania na podstawie symulacji wybranego pręta}

Na potrzeby symulacji, jako testowany obiekt, przyjęty został pręt wykonany ze stali czarnej o grubości 25 mm i długości dwóch metrów. Pierwszym etapem było wygenerowanie odpowiednich krzywych dyspersji. Rysunek \ref{fig:krzywestalowe} przedstawia wygenerowane krzywe dyspersji dla zdefiniowanego powyżej pręta. 
\begin{figure}[h]
\centering
