...
Przykładowe sygnały wejściowe wygenerowane w aplikacji zaprezentowane zostały na ryzunku \textcolor{red}{Numerek obrazka z różnymi sygnałami wejściowymi}
\textcolor{red}{obrazek z różnymi sygnałami wejściowymi}
Rysunek \textcolor{red}{Numerek obrazka z sygnalami wyłożonymi zerami} przedstawia te sygnały po wydłużeniu ich poprzez dołożenie zer.
\textcolor{red}{obrazek sygnałów z zerami}
Przykładowa krzywa dyspersji powstała w wyniku uśrednienia trzech pierwszych postaci fali zaprezentowana została na rysunku \textcolor{red}{Numerek obrazka ze średnim modem}
Na kolejnym rysunku (\textcolor{red}{Numerek obrazka wynikami symulacji - po kompensacji}) przedstawiono wyniki kompensacji sygnałów \textcolor{red}{Numerek tych pierwszych różnych sygnałów}
\textcolor{red}{obrazek z wynikami symulacji}
Kolejny rysunek przedstawia wyniki symulacji, w której sygnał nie został dostatecznie wydłużony w wyniku czego otrzymany wynik był nieczytelny \textcolor{red}{Numerek obrazka z za dużą odległością}
\textcolor{red}{obrazek z za dużą odległością}
Ostatni rysunek prezentuje porównanie skompensowanych sygnałów z sygnałami wejściowymi. \textcolor{red}{Numerek obrazka porównaniem chirpa i wyników}