...
\chapterauthor{Katarzyna Rugiełło\\Bartłomiej Piwowarczyk}
\label{cha:aplikacja}
...
\input{5_1_Instalacja_i_konfiguracja_srodowiska}

\input{5_2_Potrzebne_biblioteki}

\input{5_3_Obliczenia_MES_i_wyznaczanie_krzywych}

\input{5_4_Segregacja_krzywych_dyspersji}

\input{5_5_Metody_kompensacji_dyspersji}

\input{5_6_Graficzny_interfejs_uzytkownika}
