...
\input{4_1_Cel_kompensacji}
\input{4_2_Agregacja_krzywych_dyspersji_uzyskanych_z_zaimplementowanego_solvera}
\input{4_3_Metoda_odwracania_sygnalu_w_czasie}
\input{4_4_Metoda_taylora}
\input{4_5_Metoda_mapowania_sygnalu_z_dziedziny_czasu_na_dziedzine_odleglosci}
\input{4_6_Porownanie_opracowanych_metod_kompensacji}
